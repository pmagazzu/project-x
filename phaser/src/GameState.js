...
export const BUILDING_TYPES = {
  ...
  // Naval buildings
  NAVAL_YARD:    { name: 'Naval Yard',     ironPerTurn: 0, oilPerTurn: 0, woodPerTurn: 0, buildTurns: 3, canRecruit: ['SUPPLY_SHIP','PATROL_BOAT','SUBMARINE','LANDING_CRAFT','TRANSPORT_MD','TORPEDO_BOAT','MOTOR_GUNBOAT'], buildCost: { iron: 8, oil: 2 }, color: 0x3366aa, sight: 2 },
