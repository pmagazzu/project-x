...
export const TECH_TREE = {
  ...
  breach_charges: {
    id:'breach_charges', branch:'infantry', tier:2, kind:'module',
    name:'Breach Charges',
    desc:'🔩 MODULE — T2 infantry/engineer kit: +3 fort assault, ideal vs foxholes.',
    cost:28, prereqs:['grenade_training', 'field_fortifications'],
    effect:{ unlockModule:'INF_BREACH_CHARGE' },
  },
  siege_shells: {
    id:'siege_shells', branch:'vehicles', tier:3, kind:'module',
    name:'Siege Shells',
    desc:'🔩 MODULE — Artillery/mortar shells tuned to crack field forts.',
    cost:35, prereqs:['hv_gun_theory', 'field_fortifications'],
    effect:{ unlockModule:'ARTY_SIEGE_SHELLS' },
  },
  composite_armor_plating: {
    id:'composite_armor_plating', branch:'industrial', tier:3, kind:'module',
    name:'Composite Armor Plating',
    desc:'🔩 MODULE — T4 tank armor package (requires Armor Works + hardened steel).',
    cost:45, prereqs:['basic_steel_alloys', 'tank_siege_plating'],
    effect:{ unlockModule:'TK_COMPOSITE_ARMOR' },
  },
  jet_streamlining: {
    id:'jet_streamlining', branch:'air', tier:4, kind:'module',
    name:'Jet Streamlining',
    desc:'🔩 MODULE — T5 late-war airframe (requires Advanced Airfield + aviation alloy).',
    cost:55, prereqs:['armored_airframe'],
    effect:{ unlockModule:'AIR_JET_STREAMLINING' },
  },
  sniper_team: {
