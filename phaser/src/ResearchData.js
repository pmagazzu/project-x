...
export const TECH_TREE = {
  ...
  smg_doctrine: {
    id:'smg_doctrine', branch:'infantry', tier:1, kind:'chassis',
    name:'SMG Squad',
    desc:'🔓 NEW CHASSIS — Submachine gun squad: devastating at close range, weak beyond range 1.',
    cost:20, prereqs:['semi_auto_rifle'],
    effect:{ unlockChassis:'SMG_SQUAD' },
  },
  grenade_training: {
    id:'grenade_training', branch:'infantry', tier:1, kind:'stat',
    name:'Grenade Training',
    desc:'Infantry can throw grenades. +2 soft attack at range 0–1.',
    cost:10, prereqs:['semi_auto_rifle'],
    effect:{ unitStatBonus:{ INFANTRY:{ soft_attack:1 }, SMG_SQUAD:{ soft_attack:2 } } },
  },
  lmg_suppression: {
    id:'lmg_suppression', branch:'infantry', tier:1, kind:'chassis',
    name:'Light Machine Gun Team',
    desc:'🔓 NEW CHASSIS — LMG team: suppression fire, higher range, cannot move and fire.',
    cost:20, prereqs:['steel_helmet'],
    effect:{ unlockChassis:'LMG_TEAM' },
  },
  at_rifle_upgrade: {
  ...
  hmg_team: {
    id:'hmg_team', branch:'infantry', tier:2, kind:'chassis',
    name:'Heavy Machine Gun Team',
    desc:'🔓 NEW CHASSIS — HMG: range 3, heavy suppression, cannot move and fire same turn.',
    cost:25, prereqs:['lmg_suppression'],
    effect:{ unlockChassis:'HMG_TEAM' },
  },
  ...
  sniper_team: {
    id:'sniper_team', branch:'infantry', tier:2, kind:'chassis',
    name:'Sniper Team',
    desc:'🔓 NEW CHASSIS — Range 5, very high single-target damage, slow fire rate.',
    cost:30, prereqs:['basic_recon_training'],
    effect:{ unlockChassis:'SNIPER' },
  },
